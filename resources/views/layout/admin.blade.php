...
<head>
  ...
  <title>Dashboard RSUD Tuban</title>
  ...
  <link rel="stylesheet" href="{{ asset('tema/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('tema/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{ asset('tema/plugins/jqvmap/jqvmap.min.css') }}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('tema/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-blue-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('tema/dist/img/logors.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('tema/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
...
<!-- Sparkline -->
<script src="{{ asset('tema/plugins/sparklines/sparkline.js') }}"></script>
<!-- JQVMap -->
<script src="{{ asset('tema/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('tema/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('tema/plugins/jquery-knob/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
<script src="{{ asset('tema/plugins/moment/moment.min.js') }}"></script>
<script src="{{ asset('tema/plugins/daterangepicker/daterangepicker.js') }}"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('tema/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
