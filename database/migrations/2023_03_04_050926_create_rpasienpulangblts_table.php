...
class CreateRpasienpulangbltsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rpasienpulangblts', function (Blueprint $table) {
            $table->id();
            $table->integer('no_rm');
            $table->string('nama');
            $table->date('tgllahir');
    ...
    {
        Schema::dropIfExists('rpasienpulangblts');
    }
}
